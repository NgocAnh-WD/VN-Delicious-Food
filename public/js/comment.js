$("#comment-btn").click(function (e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var comment = '<div class="well">'+'<div class="media">' + '<div class="col-md-2">' +  '<img src="http://foodstore/'
                    ...
                    +'<a href="http://foodstore/single/'+data.product_id+'"style="color: black;">'+data.title+'</a>'+'</h4>'
