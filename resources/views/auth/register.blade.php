                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                            <label for="date_of_birth" class="col-md-4 control-label">DOB</label>
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                Female<input id="gender" type="radio" class="col-md-4 control-label" value="1">
                                Male<input id="gender" type="radio" class="col-md-4 control-label" value="0">
